...
async def run_agent(
    ...
    # Register new tools - added for enhanced functionality
    thread_manager.add_tool(SandboxVisualizationTool, project_id=project_id, thread_id=thread_id, thread_manager=thread_manager)
    thread_manager.add_tool(PlanningTool, project_id=project_id, thread_id=thread_id, thread_manager=thread_manager)
    thread_manager.add_tool(AskHumanTool, project_id=project_id, thread_id=thread_id, thread_manager=thread_manager)
    thread_manager.add_tool(ChatCompletionTool, project_id=project_id, thread_id=thread_id, thread_manager=thread_manager)
    thread_manager.add_tool(OCRTool, project_id=project_id, thread_id=thread_id, thread_manager=thread_manager)
    thread_manager.add_tool(SpeechToTextTool, project_id=project_id, thread_id=thread_id, thread_manager=thread_manager)
    thread_manager.add_tool(DocumentProcessingTool, project_id=project_id, thread_id=thread_id, thread_manager=thread_manager)
    thread_manager.add_tool(SystemInfoTool, project_id=project_id, thread_id=thread_id, thread_manager=thread_manager)
    thread_manager.add_tool(AnthropicBrowserTool, project_id=project_id, thread_id=thread_id, thread_manager=thread_manager)
    thread_manager.add_tool(CodeInterpreterTool, project_id=project_id, thread_id=thread_id, thread_manager=thread_manager)
...
#         #     raise ValueError("No personal account found")
        
#         # account_id = account_result.data.get('id')
#         # if not account_id:
#         #     raise ValueError("No account ID found in personal account")
...
#         # thread_name = f"Test Thread {uuid4()}"
...
#         #     raise ValueError("Failed to create test thread")
        
#         # thread_id = thread_result.data[0]['thread_id']

#         # # Add a test message
#         # message_content = "Hello, I need help with a Python script that calculates the Fibonacci sequence."
...
#         # # Run the agent
#         # async for chunk in run_agent(thread_id, project_id, True):
#         #     print(f"Chunk: {chunk}")
